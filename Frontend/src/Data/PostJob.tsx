const fields=[
    ...
    },
    {
        ...
        options: ["New York", "San Francisco", "Los Angeles", "Seattle", "Austin", "Chicago", "London", "Berlin", "Bangalore", "Toronto"]
    },
    {
        label: "Salary",
...
const content =
'<h4>About The Job</h4><p>Write description here...</p><h4>Responsibilities</h4><ul><li>Add responsibilities here...</li></ul><h4>Qualifications and Skill Sets</h4><ul><li>Add required qualifications and skill set here...</li></ul>';
