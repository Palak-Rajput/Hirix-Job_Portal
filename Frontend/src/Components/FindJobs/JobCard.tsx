...
const JobCard=(props:any)=>{
    ...
    <div className="flex justify-between">
        ...
        {/* {profile.savedJobs?.includes(props.id)?<IconBookmarkFilled onClick={handleSaveJob} className="text-bright-sun-400 cursor-pointer" stroke={1.5}/>:
        
        <IconBookmark onClick={handleSaveJob} className="hover:text-bright-sun-400 text-mine-shaft-300 cursor-pointer" stroke={1.5}/>} */}
    </div>
